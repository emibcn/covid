  ...
  return {
    ...
    default: (props) => (
      <div data-testid='dashboard-mock'>
        <button
          data-testid='dashboard-mock-fn-language-change'
          onClick={() => props.onLanguageChange('tested')}
        >
          Change Language
        </button>
        <button
          data-testid='dashboard-mock-fn-theme-change'
          onClick={() => props.onThemeChange('tested')}
        >
          Change Theme
        </button>
        <button
          data-testid='dashboard-mock-fn-tutorial-seen'
          onClick={() => props.onTutorialSeen('tested')}
        >
          Tutorial Seen
        </button>
